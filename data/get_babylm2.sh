...
python src/gutenberg_tokenize.py --source $DIR/dev/gutenberg.train --target $DIR/train_100M/gutenberg_sentences.train
rm $DIR/dev/gutenberg.train

python src/gutenberg_tokenize.py --source $DIR/test/gutenberg.train --target $DIR/train_100M/gutenberg_sentences.train
rm $DIR/test/gutenberg.train
