...
from tokenizers.models import Unigram, BPE, WordLevel
...
class WhitespaceTokenizer(BaseTokenizer):
    def __init__(
        ...
        self.special_tokens = {
            ...
            "eos": {"id": 1, "token": eos_token}, # same ID as bos
        ...
        self.special_tokens_list = [token for token in self.special_tokens_list if token is not None]

        model = WordLevel(unk_token=self.special_tokens["unk"]["token"])
